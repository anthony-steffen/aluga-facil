  ...
  return [
    {
      ...
      title: "Apartamento completo perto da Beira Mar",
      city: "Fortaleza",
      district: "Meireles",
      type: "Apartamento",
      price: 3200,
      ...
      description: "Ambientes bem iluminados, condominio com portaria e acesso rapido a servicos essenciais.",
    },
    {
      id: crypto.randomUUID(),
      ...
      description: "Casa ventilada para familias que buscam espaco, privacidade e boa conexao com Fortaleza.",
    },
    {
      id: crypto.randomUUID(),
      title: "Studio funcional em area central",
      city: "Fortaleza",
      district: "Aldeota",
      type: "Studio",
      price: 1850,
      ...
      description: "Planta inteligente para rotina pratica, com comercio, transporte e restaurantes por perto.",
    },
  ];
}
